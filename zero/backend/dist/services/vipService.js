...
exports.getVipTiers = getVipTiers;
...
function getVipTier(tier) {
    return VIP_TIERS.find(t => t.tier === tier);
}
function calculateVipLevel(totalRecharge) {
    if (totalRecharge >= 100000)
        return 15;
    if (totalRecharge >= 75000)
        return 14;
    if (totalRecharge >= 50000)
        return 13;
    if (totalRecharge >= 25000)
        return 12;
    if (totalRecharge >= 15000)
        return 11;
    if (totalRecharge >= 10000)
        return 10;
    if (totalRecharge >= 5000)
        return 9;
    if (totalRecharge >= 3500)
        return 8;
